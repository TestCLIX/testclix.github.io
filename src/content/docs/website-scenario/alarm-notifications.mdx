...
When the number of failed executions reaches your defined threshold, TestCLIX:
  ...
  1. marks the scenario’s status as <Badge text="Error" variant="danger"/>, and  
...
<Tabs>
  ...
  <TabItem label="Editing test" icon="pencil">
    ...
    2. Locate the scenario you want to modify.

    3. Open the scenario settings using one of the following methods:
  ...
  The scenario’s error status and notifications will update according to the thresholds you define.
  </TabItem>
</Tabs>