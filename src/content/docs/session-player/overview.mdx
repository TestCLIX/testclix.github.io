...
:::note
Replaying sessions is available from the **Viewer** role, but actions that modify the test - such as **Combine Screens** - require **Editor** or higher. See [Roles & Permissions](/project-management/permissions).
:::
