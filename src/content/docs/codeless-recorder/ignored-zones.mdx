...
1. Click any event in the Session Timeline to jump directly to it in [Preview mode](/codeless-recorder/recorder-modes#preview). You do not need to replay the scenario to that step — Preview mode lets you access any recorded step instantly.
