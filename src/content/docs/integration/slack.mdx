...
The Slack integration can be connected and managed directly from the application **Settings**. Configuring it requires the **Admin** or **Owner** role in the current project - see [Roles & Permissions](/project-management/permissions).
