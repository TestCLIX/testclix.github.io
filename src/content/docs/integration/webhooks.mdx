...
You can enable and manage Webhook from the application **Settings**. Configuring it requires the **Admin** or **Owner** role in the current project - see [Roles & Permissions](/project-management/permissions).
